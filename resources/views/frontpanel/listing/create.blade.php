        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-7 offset-md-1 mb-5 bg-white"  data-aos="fade" >
                    ...
                    <h3 class="title-exclusive pt-4"> <i class="icon ion-md-add-circle mr-2"></i> Add New Listing</h3>
                    <form action="{{ route('listing.store')  }}" method="post" enctype="multipart/form-data" class="px-5 listing-submit-form bg-white mt-3">
                        @csrf
